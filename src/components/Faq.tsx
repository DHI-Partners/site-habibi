...
const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: [
      ...
      '**Habibi** позволяет работать до 2 пользователей, а **Habibi+** — до 5 пользователей. Для Habibi Premium условия подключения пользователей зависят от конфигурации тарифа.',
  ...
  },
  {
    ...
    a: [
      ...
      'Когда вашему бизнесу потребуются дополнительные модули, интеграции или возможности, вы сможете перейти на Habibi+ или Habibi Premium.',
    ],
  },
  {
    ...
    a: [
      ...
      'На Habibi+ вы получаете доступ ко всем 10 модулям системы, до 5 пользователей и до 5 интеграций. Для компаний, которым необходимы персональное сопровождение, расширенная аналитика, гибкие права доступа и приоритетная поддержка, предусмотрен Habibi Premium.',
