...
const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: [
      ...
      '**Habibi** позволяет работать до 2 пользователей, а **Habibi Pro** — до 5 пользователей. Для Habibi Premium условия подключения пользователей зависят от конфигурации тарифа.',
  ...
  },
  {
    ...
    a: [
      'Да. Вы можете начать с тарифа **Habibi за €0 в месяц** и познакомиться с системой без оплаты.',
      'В бесплатном тарифе доступны CRM и продажи, проекты и задачи, сайт и заявки, финансы, до 2 пользователей, до 2 интеграций, 100 МБ дискового пространства и база знаний.',
      'Когда вашему бизнесу потребуются дополнительные модули, интеграции или возможности, вы сможете перейти на Habibi Pro или Habibi Premium.',
    ],
  },
  {
    q: 'Что произойдёт, если мой бизнес вырастет?',
    a: [
      'Habibi растёт вместе с вашим бизнесом. Вы можете начать с бесплатного тарифа, а затем перейти на более функциональный тариф, когда увеличится количество сотрудников, процессов и интеграций.',
      'На Habibi Pro вы получаете доступ ко всем 10 модулям системы, до 5 пользователей и до 5 интеграций. Для компаний, которым необходимы персональное сопровождение, расширенная аналитика, гибкие права доступа и приоритетная поддержка, предусмотрен Habibi Premium.',
