...
/* معاينة وحدة المشتريات — لوحة «أوامر الشراء» باللغة العربية (RTL). */

const STATS: { label: string; value: string; delta: string; up: boolean }[] = [
  { label: 'إجمالي أوامر الشراء', value: '156', delta: '18% عن الشهر الماضي', up: true },
  { label: 'إجمالي المبلغ المطلوب', value: '$245,680.00', delta: '22% عن الشهر الماضي', up: true },
  { label: 'إجمالي المبلغ المستلَم', value: '$198,420.00', delta: '16% عن الشهر الماضي', up: true },
  { label: 'إجمالي المبلغ المعلّق', value: '$47,260.00', delta: '5% عن الشهر الماضي', up: false },
  { label: 'المورّدون', value: '87', delta: '8% عن الشهر الماضي', up: true },
]

type St = 'done' | 'partial' | 'submitted' | 'pending' | 'cancelled'
const ST_LABEL: Record<St, string> = {
  done: 'مكتمل',
  partial: 'مستلَم جزئيًا',
  submitted: 'مُقدَّم',
...
const ROWS: {
  ...
  { id: 'PO-2025-00078', supplier: 'Al Madina Trading Co.', st: 'done', order: '30 يوليو 2025', schedule: '05 أغسطس 2025', total: '$12,450.00', items: 8, received: 8 },
  { id: 'PO-2025-00077', supplier: 'Global Supplies LLC', st: 'partial', order: '29 يوليو 2025', schedule: '04 أغسطس 2025', total: '$8,750.00', items: 5, received: 3 },
  { id: 'PO-2025-00076', supplier: 'Perfect Solutions', st: 'submitted', order: '29 يوليو 2025', schedule: '03 أغسطس 2025', total: '$5,230.00', items: 4, received: 0 },
  { id: 'PO-2025-00075', supplier: 'TechnoParts Inc.', st: 'done', order: '28 يوليو 2025', schedule: '02 أغسطس 2025', total: '$15,680.00', items: 10, received: 10 },
  { id: 'PO-2025-00074', supplier: 'Eastern Wholesale', st: 'pending', order: '28 يوليو 2025', schedule: '01 أغسطس 2025', total: '$9,900.00', items: 6, received: 0 },
  { id: 'PO-2025-00073', supplier: 'Al Madina Trading Co.', st: 'partial', order: '27 يوليو 2025', schedule: '31 يوليو 2025', total: '$7,450.00', items: 7, received: 2 },
  { id: 'PO-2025-00072', supplier: 'DC Office Supplies', st: 'submitted', order: '27 يوليو 2025', schedule: '30 يوليو 2025', total: '$3,210.00', items: 3, received: 0 },
  { id: 'PO-2025-00071', supplier: 'Stellar Industries', st: 'cancelled', order: '26 يوليو 2025', schedule: '29 يوليو 2025', total: '$4,120.00', items: 5, received: 0 },
  { id: 'PO-2025-00070', supplier: 'Global Supplies LLC', st: 'done', order: '26 يوليو 2025', schedule: '28 يوليو 2025', total: '$11,670.00', items: 9, received: 9 },
  { id: 'PO-2025-00069', supplier: 'Perfect Solutions', st: 'pending', order: '25 يوليو 2025', schedule: '27 يوليو 2025', total: '$6,360.00', items: 6, received: 0 },
]
...
const TOP_SUPPLIERS: { label: string; value: string; color: string }[] = [
  ...
  { label: 'أخرى', value: '$58,300.00 (23.7%)', color: '#cbd5e1' },
]

const STATUS_DIST: { label: string; value: string; color: string }[] = [
  { label: 'مكتمل', value: '56 (35.9%)', color: '#10b981' },
  { label: 'مستلَم جزئيًا', value: '32 (20.5%)', color: '#f59e0b' },
  { label: 'مُقدَّم', value: '24 (15.4%)', color: '#3b82f6' },
  { label: 'قيد الانتظار', value: '26 (16.7%)', color: '#f97316' },
  { label: 'ملغى', value: '18 (11.5%)', color: '#ef4444' },
]
...
export default function PurchasesPreview() {
  return (
    <AppShell
      ...
      reports={['أوامر الشراء', 'إيصالات الاستلام', 'المورّدون', 'الأصناف', 'عروض المورّدين', 'التقارير']}
    >
      {/* رأس الصفحة */}
      <div className="mb-5 flex flex-wrap items-center justify-between gap-3">
        <h3 className="text-xl font-bold text-slate-900">أوامر الشراء</h3>
      ...
      <div className="overflow-hidden rounded-xl border border-slate-200 bg-white">
        <div className="overflow-x-auto">
          <table className="w-full min-w-[820px] text-right text-[12px]">
            <thead>
              <tr className="border-b border-slate-100 text-slate-400">
                <th className="p-3 font-medium">المعرّف</th>
                <th className="p-3 font-medium">المورّد</th>
                <th className="p-3 font-medium">الحالة</th>
                <th className="p-3 font-medium">تاريخ الطلب</th>
                <th className="p-3 font-medium">تاريخ الجدولة</th>
                <th className="p-3 font-medium">الإجمالي</th>
                <th className="p-3 font-medium">الأصناف</th>
                <th className="p-3 font-medium">المستلَم</th>
              </tr>
            </thead>
            <tbody>
              {ROWS.map((r) => (
      ...
      <div className="mt-5 grid grid-cols-1 gap-4 lg:grid-cols-3">
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <h4 className="mb-3 text-sm font-semibold text-slate-900">اتجاهات أوامر الشراء</h4>
          ...
          <div className="flex items-center gap-4 text-[11px] text-slate-500">
            <span className="flex items-center gap-1.5">
              <span className="h-2 w-2 rounded-full bg-blue-500" /> هذا الشهر
            </span>
            <span className="flex items-center gap-1.5">
              <span className="h-2 w-2 rounded-full bg-emerald-500" /> الشهر الماضي
            </span>
          </div>
        </div>

        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <h4 className="mb-3 text-sm font-semibold text-slate-900">أعلى المورّدين حسب المبلغ</h4>
        ...
        <div className="rounded-xl border border-slate-200 bg-white p-4">
          <h4 className="mb-3 text-sm font-semibold text-slate-900">حالة أوامر الشراء</h4>
          <div className="flex items-center gap-4">
            <Donut
              segments={[
                '#10b981 0 35.9%',
