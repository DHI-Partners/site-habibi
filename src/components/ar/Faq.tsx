...
const FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: [
      ...
      'تتيح باقة **Habibi Pro** عددًا غير محدود من المستخدمين. وفي **Habibi Premium** تُحدَّد شروط إضافة المستخدمين بحسب تهيئة الحلّ.',
  ...
  },
  {
    q: 'كم تكلفة Habibi؟',
    a: [
      'باقة **Habibi Pro** بـ 290$ شهريًا، وتشمل جميع وحدات النظام العشر وعددًا غير محدود من المستخدمين والتحليلات المتقدّمة والدعم ذا الأولوية.',
      '**Habibi Premium** حلّ مخصّص تُحدَّد تكلفته بعد تدقيق أعمالك، ويشمل الإعداد المخصّص وتنفيذ وحدة مخصّصة ابتداءً من 300$ ومرافقة كاملة ودعم 24/7.',
    ],
  },
  {
    q: 'ماذا يحدث إذا نمَت أعمالي؟',
    a: [
      'ينمو Habibi مع أعمالك. تبدأ بباقة Habibi Pro التي تمنحك كل وحدات النظام العشر وعددًا غير محدود من المستخدمين والتكاملات.',
