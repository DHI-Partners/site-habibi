...
export default function Closing() {
  ...
  return (
    <section className="relative overflow-hidden bg-black px-6 py-24 md:px-12 md:py-32 lg:px-16">
      ...
      {/* Затемнение поплотнее; края уходят в чёрный для бесшовного стыка */}
      ...
      <div className="relative z-10 mx-auto max-w-4xl text-center">
        <Reveal>
          <h2 className="text-3xl font-medium leading-[1.15] tracking-tight text-white sm:text-4xl md:text-5xl">
            Habibi — oʻnta tarqoq dastur oʻrniga yagona tizim
          </h2>
        </Reveal>
        <Reveal delay={0.1}>
          <p className="mx-auto mt-6 max-w-2xl text-base leading-relaxed text-white/60 md:text-lg">
            Savdo omborni koʻradi, ombor xaridlarni koʻradi, siz esa butun biznesni bir vaqtda
            koʻrasiz. 14 kun bepul sinab koʻring va Habibi bilan birga oʻsing.
          </p>
        </Reveal>
        <Reveal delay={0.2}>
          <LiquidButton
