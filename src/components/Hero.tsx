...
const ASK_LABELS = {
  ...
  sendLabel: 'Спросить',
  hint: 'Ответит ИИ-консультант Habibi — сразу, без ожидания',
  prompts: [
    'Как автоматизировать учёт склада?',
    'Как перестать терять заявки из WhatsApp?',
    'Сколько стоит Habibi?',
    'Как видеть прибыль в реальном времени?',
  ],
}
